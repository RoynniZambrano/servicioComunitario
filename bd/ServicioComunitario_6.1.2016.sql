...
CREATE  TABLE IF NOT EXISTS `profesor` (
  ...
  `coordinadores_has_profesor_profesor_id_proyecto` INT(11) NOT NULL ,
  `coordinadores_has_profesor_coordinadores_id_coordinadores` INT NOT NULL ,
  PRIMARY KEY (`id_profesor`, `coordinadores_has_profesor_profesor_id_proyecto`, `coordinadores_has_profesor_coordinadores_id_coordinadores`) )
...
CREATE  TABLE IF NOT EXISTS `coordinadores_has_profesor` (
  `coordinadores_has_profesor_id` INT NOT NULL ,
  `profesor_id_suplente` INT NOT NULL ,
  `proyecto_id_proyecto` INT NOT NULL ,
  PRIMARY KEY (`coordinadores_has_profesor_id`, `profesor_id_suplente`, `proyecto_id_proyecto`) ,
  INDEX `fk_coordinadores_has_profesor_profesor1_idx` (`profesor_id_suplente` ASC) ,
  INDEX `fk_coordinadores_has_profesor_proyecto1_idx` (`proyecto_id_proyecto` ASC) ,
  CONSTRAINT `fk_coordinadores_has_profesor_profesor1`
    FOREIGN KEY (`profesor_id_suplente` )
    REFERENCES `profesor` (`id_profesor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_coordinadores_has_profesor_proyecto1`
    FOREIGN KEY (`proyecto_id_proyecto` )
    REFERENCES `proyecto` (`id_proyecto` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
