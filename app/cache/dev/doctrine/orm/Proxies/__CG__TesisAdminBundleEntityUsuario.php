 ...
 */
class Usuario extends \Tesis\AdminBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'apellido', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'cedula', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'clave', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'correo', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'telefono', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'genero', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'rol', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'departamento', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'periodo', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'idUsuario', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Usuario' . "\0" . 'tutoriaTutores');
        }
    ...
    public function addTutoriaTutore(\Tesis\AdminBundle\Entity\Tutoria $tutoriaTutores)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTutoriaTutore', array($tutoriaTutores));

        return parent::addTutoriaTutore($tutoriaTutores);
    }
    ...
    public function removeTutoriaTutore(\Tesis\AdminBundle\Entity\Tutoria $tutoriaTutores)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTutoriaTutore', array($tutoriaTutores));

        return parent::removeTutoriaTutore($tutoriaTutores);
    }
    ...
    public function getTutoriaTutores()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTutoriaTutores', array());

        return parent::getTutoriaTutores();
    }
