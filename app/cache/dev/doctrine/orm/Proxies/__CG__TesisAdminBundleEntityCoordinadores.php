 ...
 */
class Coordinadores extends \Tesis\AdminBundle\Entity\Coordinadores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Coordinadores' . "\0" . 'idCoordinadores', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Coordinadores' . "\0" . 'proyectoProyecto');
        }
    ...
    public function getIdCoordinadores()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCoordinadores();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCoordinadores', array());

        return parent::getIdCoordinadores();
    }
