 ...
 */
class Adicionales extends \Tesis\AdminBundle\Entity\Adicionales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Adicionales' . "\0" . 'nombre', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Adicionales' . "\0" . 'cantidad', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Adicionales' . "\0" . 'comentario', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Adicionales' . "\0" . 'idAdicionales', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Adicionales' . "\0" . 'diarioDiario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Adicionales $proxy) {
    ...
    public function getIdAdicionales()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdAdicionales();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdAdicionales', array());

        return parent::getIdAdicionales();
    }
    ...
    public function setDiarioDiario(\Tesis\AdminBundle\Entity\Diario $diarioDiario = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDiarioDiario', array($diarioDiario));

        return parent::setDiarioDiario($diarioDiario);
    }
