...
/* TesisAdminBundle:CoordinadoresHasProfesor:edit-coordinadores-form.html.twig */
class __TwigTemplate_bfabcc676642a13dc0c3e256f4ad686a91a53eb7bcbdf33a0d316591a3450e4d extends Twig_Template
{
...
";
        // line 2
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'form_start', array("attr" => array("novalidate" => "novalidate", "id" => "editar-coordinadores-form")));
        echo "
\t";
        // line 3
...
\t\t\t\t";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "profesorProyecto", array()), 'row');
        echo " 
\t\t\t</div>
\t    \t<div class=\"col-xs-8 col-xs-offset-1 col-sm-4 col-sm-offset-1 col-md-4 col-md-offset-1 col-lg-3 \tcol-lg-offset-0\">
\t\t\t\t";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "profesorSuplente", array()), 'row');
        echo "
\t\t\t</div>
\t\t</div>\t
\t</div>\t\t
...
\t<br><br>
\t<div class=\"row\">
\t\t<div class=\"col-xs-8 col-xs-offset-1 col-sm-2 col-sm-offset-3 col-md-2 col-md-offset-4 col-lg-3   col-lg-offset-2\" align=\"center\" style=\"margin-bottom: 2%;\" id=\"editar-coordinadores-boton\">
...
";
    ...
    {
        return "TesisAdminBundle:CoordinadoresHasProfesor:edit-coordinadores-form.html.twig";
    }
    ...
    {
        return array (  93 => 49,  89 => 48,  79 => 41,  59 => 24,  53 => 21,  42 => 13,  36 => 10,  28 => 4,  26 => 3,  22 => 2,  19 => 1,);
    }
}
/* */
/* {{ form_start(form, {'attr': {novalidate: 'novalidate', id: 'editar-coordinadores-form'}}) }}*/
...
/* 		<div class="form-group">*/
/* 	    	<div class="col-xs-8 col-xs-offset-1 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-2 col-lg-3 	col-lg-offset-2">*/
/* 				{{ form_row(form.profesorProyecto) }} */
/* 			</div>*/
/* 	    	<div class="col-xs-8 col-xs-offset-1 col-sm-4 col-sm-offset-1 col-md-4 col-md-offset-1 col-lg-3 	col-lg-offset-0">*/
/* 				{{ form_row(form.profesorSuplente) }}*/
/* 			</div>*/
/* 		</div>	*/
/* 	</div>		*/
/* */
