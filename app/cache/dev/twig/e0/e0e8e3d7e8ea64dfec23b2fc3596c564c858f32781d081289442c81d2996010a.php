...
class __TwigTemplate_48c2ab4dbf360bc409d1bdd4dbecd7ce5a413196d338c9c574fc0e7fda571973 extends Twig_Template
{
...
\t\t\t\t";
        // line 33
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "rol", array()), 'row');
        echo " 
\t\t\t</div>\t
\t    \t<div class=\"col-xs-8 col-xs-offset-1 col-sm-4 col-sm-offset-1 col-md-4 col-md-offset-1 col-lg-3 \tcol-lg-offset-0\">
\t\t\t\t";
...
\t\t";
        // line 60
        if ((($this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "rol", array()) == "coordinador de servicio comunitario") && ((isset($context["same"]) ? $context["same"] : $this->getContext($context, "same")) == "false"))) {
            // line 61
