...
class __TwigTemplate_23aeb68f3536c770c890602b361de96f798df3eb4f1087193d00e5eb45af857a extends Twig_Template
{
...
";
        // line 2
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'form_start', array("attr" => array("novalidate" => "novalidate", "id" => "loggin-form")));
        echo "
\t";
        // line 3
        $this->env->getExtension('form')->renderer->setTheme((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), array(0 => "TesisSCBundle:Form:fields.html.twig"));
        // line 4
        echo "\t\t<div class=\"row\">
