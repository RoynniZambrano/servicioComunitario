...
class __TwigTemplate_a19822249a74e4ccff41c982853c7eb140fd3d166d3e997a78708171dd1adda0 extends Twig_Template
{
...
\t       ";
            // line 28
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "view", array()), 'row', array("attr" => array("class" => "btn btn-success btn-lg")));
            echo " 
\t    </div>  
...
\t\t\t";
            // line 41
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "edit", array()), 'row', array("attr" => array("class" => "btn btn-primary btn-lg")));
            echo " 
\t\t</div>\t
