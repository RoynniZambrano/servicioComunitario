...
/* TesisAdminBundle:Adicionales:edit-adicionales.html.twig */
class __TwigTemplate_300cf5b7899aeacdf0cb77e6f1d43d51d4bba206b4bc5814b39ede5b83c66332 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("::admin_base.html.twig", "TesisAdminBundle:Adicionales:edit-adicionales.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"wrapper\">
      ...
      ";
        ...
        // line 30
        echo "              <li class=\"active\">Diario de campo</li>
              <li class=\"active\">Editar actividad adicional</li>
            </ol>
          </section>
          ...
          <section class=\"content\">
            ...
            <div class=\"box box-primary\">
              <div class=\"box-header with-border\">
                ...
                <!-- form -->
                <div id=\"editar-resultados-div\">
                    ";
        // line 49
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("TesisAdminBundle:Adicionales:editform", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))));
        echo "
                </div>
...
";
    ...
    {
        return "TesisAdminBundle:Adicionales:edit-adicionales.html.twig";
    }
...
/*               {% endif %}*/
/*               <li class="active">Diario de campo</li>*/
/*               <li class="active">Editar actividad adicional</li>*/
/*             </ol>*/
/*           </section>*/
/* */
...
/*                 <!-- form -->*/
/*                 <div id="editar-resultados-div">*/
/*                     {{ render(controller('TesisAdminBundle:Adicionales:editform', {'id': id})) }}*/
/*                 </div>*/
/* */
/*             </div><!-- /.box -->*/
/*           </section><!-- /.content -->*/
