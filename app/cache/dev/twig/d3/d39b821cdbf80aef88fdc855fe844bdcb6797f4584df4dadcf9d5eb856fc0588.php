...
class __TwigTemplate_2e28fe1b0cbddad62d111b2b602ef4717ec3499787bd4144cf456f4f9b6efdbf extends Twig_Template
{
    ...
    <div class=\"wrapper\">
      ...
      ";
        ...
        // line 30
        echo "              <li class=\"active\">Consultar informe final</li>
            </ol>
          </section>
          ...
          <section class=\"content\">
            ...
            <div class=\"box box-primary\">
              <div class=\"box-header with-border\">
                ...
                <!-- form  <div id=\"consultar-diario-div\">-->
                <div>
                    ";
        // line 48
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("TesisAdminBundle:InfoFinal:checkform", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))));
        echo "
                </div>
...
/*               {% endif %}*/
/*               <li class="active">Consultar informe final</li>*/
/*             </ol>*/
/*           </section>*/
/* */
/*           <!-- Main content -->*/
