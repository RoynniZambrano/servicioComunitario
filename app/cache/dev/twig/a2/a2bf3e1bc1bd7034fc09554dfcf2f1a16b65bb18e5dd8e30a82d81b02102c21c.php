...
/* TesisAdminBundle:Reports:reports5.html.twig */
class __TwigTemplate_d2c7d6ad897453509f84764be4ed9eebd00ed3df208c337b5219c68584e7726b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("::admin_base.html.twig", "TesisAdminBundle:Reports:reports5.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"wrapper\">
      ...
      ";
        ...
        echo "\"><i class=\"fa fa-dashboard\"></i>Inicio</a></li>
              ...
              <li class=\"active\">Reporte proyectos</li>
            </ol>
          </section>
          ...
          <section class=\"content\">
            ...
            <div class=\"box box-primary\">
              <div class=\"box-header with-border\">
                <h3 class=\"box-title\">Reporte de proyectos</h3>
            ...
            <div style=\"margin-top: 4%; padding-bottom: 20px;\">
                <div class=\"row\" >
                  <div class=\"col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3\">
                    <p class=\"parrafo\">
                    El reporte de proyectos, contiene la información de todos los proyectos registrados en el Sistema.
                  </p>
                </div>
                </div>
              ...
              <div class=\"row\" style=\"margin-top: 2%;\"> 
                ";
        // line 50
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("TesisAdminBundle:Reports:report5form"));
        echo "
              </div>
            </div>
...
";
    ...
    {
        return "TesisAdminBundle:Reports:reports5.html.twig";
    }
...
/*               */
/*               <div class="row" style="margin-top: 2%;"> */
/*                 {{ render(controller('TesisAdminBundle:Reports:report5form')) }}*/
/*               </div>*/
/*             </div>*/
/* */
/*             </div><!-- /.box -->*/
