          ...
          <section class=\"content\">
            ...
            <div class=\"box box-primary\">
              <div class=\"box-header with-border\">
                <h3 class=\"box-title\">Visualizar informe final</h3>
              ...
              <div class=\"row\" style=\"margin-top: 4%; padding-bottom: 20px;\">
                <div class=\"col-xs-6 col-xs-offset-1 col-sm-6 col-sm-offset-2 col-md-5 col-md-offset-2 col-lg-4 col-lg-offset-3\">
                    <p class=\"parrafo\">
                    El informe final es generado automaticamente por el Sistema de Servicio Comunitario, basado en la información sumistrada por el estudiante en el Sistema. El informe final contiene información de los periodos, diarios de campos y de la información adicional.
                  </p>
                </div>
