...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'delete_service' => 'getDeleteServiceService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Tesis\ApiBundle\Services\CheckService A Tesis\ApiBundle\Services\CheckService instance.
     */
    protected function getCheckServiceService()
    {
        return $this->services['check_service'] = new \Tesis\ApiBundle\Services\CheckService();
    }
    ...
    /**
     * Gets the 'delete_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tesis\ApiBundle\Services\DeleteService A Tesis\ApiBundle\Services\DeleteService instance.
     */
    protected function getDeleteServiceService()
    {
        return $this->services['delete_service'] = new \Tesis\ApiBundle\Services\DeleteService();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ServicioComunitario', 'user' => 'SC', 'password' => 'serviciocomunitario', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Tesis/AdminBundle/Resources/config/doctrine') => 'Tesis\\AdminBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Tesis/SCBundle/Entity'))), 'Tesis\\SCBundle\\Entity');
        $b->addDriver($a, 'Tesis\\AdminBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('TesisSCBundle' => 'Tesis\\SCBundle\\Entity', 'TesisAdminBundle' => 'Tesis\\AdminBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Tesis/SCBundle/Resources/views'), 'TesisSC');
        $instance->addPath(($this->targetDirs[3].'/src/Tesis/AdminBundle/Resources/views'), 'TesisAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/Tesis/ApiBundle/Resources/views'), 'TesisApi');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TesisSCBundle' => 'Tesis\\SCBundle\\TesisSCBundle',
                'TesisAdminBundle' => 'Tesis\\AdminBundle\\TesisAdminBundle',
                'TesisApiBundle' => 'Tesis\\ApiBundle\\TesisApiBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ServicioComunitario',
            'database_user' => 'SC',
            'database_password' => 'serviciocomunitario',
