 ...
 */
class Cronograma extends \Tesis\AdminBundle\Entity\Cronograma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'semana', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'fechaInicio', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'fechaFin', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'comentario', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'horas', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'calificacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'observacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'personas', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'idcronograma', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'estudianteEstudiante', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Cronograma' . "\0" . 'actividadActividad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cronograma $proxy) {
    ...
    public function getIdcronograma()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdcronograma();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdcronograma', array());

        return parent::getIdcronograma();
    }
