 ...
 */
class Informe extends \Tesis\AdminBundle\Entity\Informe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Informe' . "\0" . 'calificacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Informe' . "\0" . 'observacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Informe' . "\0" . 'idInforme', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Informe' . "\0" . 'idEstudiante');
        }
    ...
    public function getIdInforme()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdInforme();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdInforme', array());

        return parent::getIdInforme();
    }
