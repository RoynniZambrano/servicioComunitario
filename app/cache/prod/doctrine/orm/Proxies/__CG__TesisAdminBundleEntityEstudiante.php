...
class Estudiante extends \Tesis\AdminBundle\Entity\Estudiante implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'nombre', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'apellido', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'cedula', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'clave', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'correo', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'telefono', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'sc', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'genero', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'rol', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'departamento', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'periodo', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'idEstudiante', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'proyectoProyecto', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Estudiante' . "\0" . 'usuarioUsuario');
        }
    ...
    public function setUsuarioUsuario(\Tesis\AdminBundle\Entity\Usuario $usuarioUsuario = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsuarioUsuario', array($usuarioUsuario));
    ...
    public function getUsuarioUsuario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsuarioUsuario', array());
