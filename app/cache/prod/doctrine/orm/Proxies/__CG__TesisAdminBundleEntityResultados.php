 ...
 */
class Resultados extends \Tesis\AdminBundle\Entity\Resultados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Resultados' . "\0" . 'nombre', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Resultados' . "\0" . 'cantidad', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Resultados' . "\0" . 'comentario', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Resultados' . "\0" . 'idResultados', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Resultados' . "\0" . 'diarioDiario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Resultados $proxy) {
    ...
    public function getIdResultados()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdResultados();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdResultados', array());

        return parent::getIdResultados();
    }
