...
class Diario extends \Tesis\AdminBundle\Entity\Diario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'fecha', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'personal', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'fortalezas', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'debilidades', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'conclusion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'horaInicio', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'horaFin', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'personas', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'calificacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'observacion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'descripcion', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'horas', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'ninos', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'adultos', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'terceraEdad', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'discapacidad', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'idDiario', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'cronogramacronograma', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'proyectoProyecto', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'estudianteEstudiante', '' . "\0" . 'Tesis\\AdminBundle\\Entity\\Diario' . "\0" . 'actividadActividad');
        }
    ...
    public function setCronogramacronograma(\Tesis\AdminBundle\Entity\Cronograma $cronogramacronograma = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCronogramacronograma', array($cronogramacronograma));

        return parent::setCronogramacronograma($cronogramacronograma);
    }
